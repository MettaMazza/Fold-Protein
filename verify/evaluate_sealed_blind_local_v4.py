#!/usr/bin/env python3
"""Post-seal same-index local evaluation for selector v4."""
...
from verify.evaluate_sealed_blind_v4 import verify_v4_seal  # noqa: E402
...
def evaluate(manifest: Path, sealed_dir: Path, target_path: Path,
    ...
    seal, states = verify_v4_seal(manifest, sealed_dir)
    ...
    result = {
        "schema": "fold-protein-blind-local-evaluation/v4",
        "status": "completed",
        "run_id": seal["run_id"],
