#!/usr/bin/env python3
"""Post-seal same-index local evaluation for selector v6."""
...
from verify.evaluate_sealed_blind_v6 import sha256, verify_v6_seal  # noqa: E402
...
def evaluate(manifest: Path, sealed_dir: Path, target_path: Path,
    ...
    seal, states = verify_v6_seal(manifest, sealed_dir)
    ...
    result = {
        "schema": "fold-protein-blind-local-evaluation/v6",
        "status": "completed",
        "run_id": seal["run_id"],
