#!/usr/bin/env python3
"""Post-seal same-index local evaluation for selector v10."""
...
from verify.evaluate_sealed_blind_v10 import sha256, verify_v10_seal  # noqa: E402
...
def evaluate(manifest: Path, sealed_dir: Path, target_path: Path,
    ...
    seal, states = verify_v10_seal(manifest, sealed_dir)
    ...
    result = {
        "schema": "fold-protein-blind-local-evaluation/v10",
        "status": "completed",
        "run_id": seal["run_id"],
        ...
        "provenance": {
            ...
            "authority": (
                "Maria Smith owns publishable conclusions and project direction."),
        },
        "source_sha256": {
