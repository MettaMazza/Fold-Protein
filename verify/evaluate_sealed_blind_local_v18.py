#!/usr/bin/env python3
"""Post-seal same-index local evaluation for selector v18."""
...
from verify.evaluate_sealed_blind_v18 import sha256, verify_v18_seal  # noqa: E402
...
def evaluate(manifest: Path, sealed_dir: Path, target_path: Path,
    ...
    seal, states = verify_v18_seal(manifest, sealed_dir)
    ...
    result = {
        "schema": "fold-protein-blind-local-evaluation/v18",
        "status": "completed",
