#!/usr/bin/env python3
"""Post-seal same-index local evaluation for selector v15."""
...
from verify.evaluate_sealed_blind_v15 import sha256, verify_v15_seal  # noqa: E402
...
def evaluate(manifest: Path, sealed_dir: Path, target_path: Path,
    ...
    seal, states = verify_v15_seal(manifest, sealed_dir)
    ...
    result = {
        "schema": "fold-protein-blind-local-evaluation/v15",
        "status": "completed",
        ...
        "provenance": {
            ...
            "authority":
                "Maria Smith alone assigns conclusions and official status.",
        },
        "source_sha256": {
