#!/usr/bin/env python3
"""Post-seal same-index local evaluation for selector v16."""
...
from verify.evaluate_sealed_blind_v16 import sha256, verify_v16_seal  # noqa: E402
...
def evaluate(manifest: Path, sealed_dir: Path, target_path: Path,
    ...
    seal, states = verify_v16_seal(manifest, sealed_dir)
    ...
    result = {
        "schema": "fold-protein-blind-local-evaluation/v16",
        "status": "completed",
