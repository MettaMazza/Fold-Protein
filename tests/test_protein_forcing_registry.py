...
class ProteinForcingRegistryTests(unittest.TestCase):
    def test_every_source_is_classified_and_active_routes_have_clean_closure(self):
        ...
        self.assertEqual(receipt["artifact_inventory"]["tracked_pdb_files"], 137)
        self.assertEqual(
        ...
        self.assertEqual(
            receipt["artifact_inventory"]["class_counts"][
                "sealed_v33_minimax_topology_consensus_development_output"],
            3,
        )
        self.assertEqual(
            receipt["artifact_inventory"]["class_counts"][
                "sealed_v34_closed_domain_forward_forcing_output"],
            3,
        )
        self.assertEqual(
            receipt["artifact_inventory"]["class_counts"][
        ...
        self.assertEqual(
            receipt["artifact_inventory"]["class_counts"][
                "sealed_v40_lineage_paired_fixed_point_forward_forcing_output"],
            1,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            receipt["v35_generalisation"]["proteins_with_tm_improvement"], 2)
        self.assertEqual(
            receipt["v35_generalisation"]["proteins_with_ca_drmsd_improvement"], 2)
        self.assertEqual(
